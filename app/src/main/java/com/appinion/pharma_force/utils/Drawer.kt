...
import com.appinion.pharma_force.base.DASHBOARD_SCREEN
...
sealed class DrawerScreens(val title: String, val route: String) {
    ...
    object DashBoardScreen : DrawerScreens(route= DASHBOARD_SCREEN,title="DashBoard")
